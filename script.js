...
function criarLista() {
   let table = "<tr><th>Id</th><th>Produtos</th><th>Valor</th><th>Ações</th></tr>";

   for (let i = 0; i < produto.length; i++) {
       table += "<tr><td>" + (i + 1) + "</td><td>" + produto[i] + "</td><td>" + valor[i] + "</td><td><button class='btn btn-success' onclick='editar(" + (i + 1) + ")'>Editar</button><button class='btn btn-danger' onclick='excluir(" + (i + 1) + ")'>Excluir</button></td></tr>";
   }
